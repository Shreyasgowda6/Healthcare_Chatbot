...
# =====================================================  LOAD MODELS ==================================================
dtc , le  = pk.load(open(r'C:\Users\Somashekar\OneDrive\Desktop\chatbot\HealthCare_ChatBot\chatbot_modelsave','rb'))
model,second_le  = pk.load(open(r'C:\Users\Somashekar\OneDrive\Desktop\chatbot\HealthCare_ChatBot\chatbot_model','rb'))
ners = pk.load(open(r'C:\Users\Somashekar\OneDrive\Desktop\chatbot\HealthCare_ChatBot\newsave_model','rb'))

# Load NN Model 
FILE = "C:\Users\Somashekar\OneDrive\Desktop\chatbot\HealthCare_ChatBot\data.pth"
